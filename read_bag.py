...
combined_infrareds_csvs.to_csv("/home/vboxuser/MMP/catkin_ws/src/rosbag_files/final_csvs/combined_infrareds.csv")
combined_cmd_vel_csvs.to_csv("/home/vboxuser/MMP/catkin_ws/src/rosbag_files/final_csvs/combined_cmd_vel.csv")

#Create a numpy array from the new concatenated csv 
infrareds_np_array = genfromtxt("/home/vboxuser/MMP/catkin_ws/src/rosbag_files/final_csvs/combined_infrareds.csv", delimiter=',')
cmd_vel_np_array = genfromtxt("/home/vboxuser/MMP/catkin_ws/src/rosbag_files/final_csvs/combined_cmd_vel.csv", delimiter=',')

#Extract the columns we are interested in from the numpy array
infrareds_np_array = infrareds_np_array[:,[10,19,28,37,46,55,64]]
cmd_vel_np_array = cmd_vel_np_array[:,[2,7]]
